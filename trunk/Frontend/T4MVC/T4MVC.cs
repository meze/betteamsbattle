...
namespace T4MVC {
    ...
    public class NotAdminClass {
        ...
        public BetTeamsBattle.Frontend.Areas.NotAdmin.Controllers.BetsController Bets = new BetTeamsBattle.Frontend.Areas.NotAdmin.Controllers.T4MVC_BetsController();
