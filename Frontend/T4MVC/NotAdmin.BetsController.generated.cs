...
namespace BetTeamsBattle.Frontend.Areas.NotAdmin.Controllers {
    public partial class BetsController {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected BetsController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public BetsController Actions { get { return MVC.NotAdmin.Bets; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "notadmin";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "bets";
        ...
        public class ViewNames {
            public readonly string _DateAndScreenshot = "~/Areas/NotAdmin/Views/Bets/_DateAndScreenshot.cshtml";
            public readonly string _Outcome = "~/Areas/NotAdmin/Views/Bets/_Outcome.cshtml";
            public readonly string GetBets = "~/Areas/NotAdmin/Views/Bets/GetBets.cshtml";
            public readonly string MakeBet = "~/Areas/NotAdmin/Views/Bets/MakeBet.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_BetsController: BetTeamsBattle.Frontend.Areas.NotAdmin.Controllers.BetsController {
        public T4MVC_BetsController() : base(Dummy.Instance) { }
