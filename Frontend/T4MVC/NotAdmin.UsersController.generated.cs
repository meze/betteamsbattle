...
namespace BetTeamsBattle.Frontend.Areas.NotAdmin.Controllers {
    public partial class UsersController {
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public System.Web.Mvc.ActionResult GetUser() {
            return new T4MVC_ActionResult(Area, Name, ActionNames.GetUser);
        }
        ...
        public class ActionNamesClass {
            public readonly string GetUser = ("GetUser").ToLowerInvariant();
        }
        ...
        public class ViewNames {
            public readonly string GetUser = "~/Areas/NotAdmin/Views/Users/GetUser.cshtml";
        }
    }
    ...
    public class T4MVC_UsersController: BetTeamsBattle.Frontend.Areas.NotAdmin.Controllers.UsersController {
        ...
        public override System.Web.Mvc.ActionResult GetUser(long userId) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.GetUser);
